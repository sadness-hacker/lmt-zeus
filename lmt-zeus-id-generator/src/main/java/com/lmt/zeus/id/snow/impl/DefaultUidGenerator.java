 ...
 */
package com.lmt.zeus.id.snow.impl;

import com.lmt.zeus.id.snow.BitsAllocator;
...
public class DefaultUidGenerator implements UidGenerator, InitializingBean {
    ...
    protected String epochStr = "2019-10-24";
    protected long epochSeconds = TimeUnit.MILLISECONDS.toSeconds(1571846400000L);
