...
import com.lmt.zeus.parent.mybatis.BasicMapper;
...
public class BasicServiceImpl<T extends Entity,PK extends Serializable> implements BasicService<T, PK>{
    ...
    private Object getPkValue(T entity) {
        try {
            ...
            throw ZeusException.wrap(ZeusExceptionEnum.ENTITY_ID_REFLECT_GETTER_ERROR.getCode(), ZeusExceptionEnum.ENTITY_ID_REFLECT_GETTER_ERROR.getMsg(), e);
        }
        return null;
    }
    ...
    private void setPkValue(T entity, PK id) {
        try {
            ...
            throw ZeusException.wrap(ZeusExceptionEnum.ENTITY_ID_REFLECT_SETTER_ERROR.getCode(), ZeusExceptionEnum.ENTITY_ID_REFLECT_GETTER_ERROR.getMsg(), e);
        }
    }
